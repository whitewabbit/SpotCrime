...
<html>
    ...
    <body>
        ...
        <header>
            ...
            <ul>
                <li><a href="assets/jsp/dashboard.jsp" target="view">Dashboard</a></li>
                <li><a href="assets/jsp/recordblotter.jsp" target="view">Record Blotter</a></li>
                <li><a href="assets/jsp/graph.jsp" target="view">Tabular & Graphical Data</a></li>
                <li><a href="assets/jsp/mapping.jsp" target="view">Mapping</a></li>
        ...
        <div class="myHr"></div>
        <iframe src="assets/jsp/dashboard.jsp" name="view"></iframe>
    </body>
</html>
